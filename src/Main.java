public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Ежемесяный платеж: " +  monthlypayment12);
        ...
        System.out.println("Ежемесяный платеж: " +  monthlypayment24);
        ...
        System.out.println("Ежемесяный платеж: " +  monthlypayment36);
    }
}